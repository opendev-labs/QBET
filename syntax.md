...
## 1. Basic Structure
- **Statements**: Define how statements are structured in QBET, including assignment, function call, and return statements.
- **Expressions**: Describe the rules for forming expressions, including operator precedence and associativity.
- **Blocks**: Explain how code blocks are defined and used, specifying if they are delimited by braces or indentation.
