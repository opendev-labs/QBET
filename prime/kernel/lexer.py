...
class Lexer:
    KEYWORDS = {
        ...
        "universe": TokenType.IDENTIFIER, # Handle as ident for lowerer consistency or special-case
        "entity": TokenType.IDENTIFIER,
        "manifest": TokenType.IDENTIFIER,
        "flow": TokenType.IDENTIFIER,
    }
